...
#pragma region IDC
	...
	inline bool IsKeyDown(ImGuiKey user_key_index) { return ImGui::IsKeyDown(user_key_index); }
	inline bool IsKeyPressed(ImGuiKey user_key_index) { return ImGui::IsKeyPressed(user_key_index); }
	inline bool IsKeyPressed(ImGuiKey user_key_index, bool repeat) { return ImGui::IsKeyPressed(user_key_index, repeat); }
	inline bool IsKeyReleased(ImGuiKey user_key_index) { return ImGui::IsKeyReleased(user_key_index); }
	inline int GetKeyPressedAmount(ImGuiKey key_index, float repeat_delay, float rate) { return ImGui::GetKeyPressedAmount(key_index, repeat_delay, rate); }
...
#pragma region Inputs Utilities: Keyboard
		...
		ImGui.set_function("IsKeyPressed", sol::overload(
			sol::resolve<bool(ImGuiKey)>(IsKeyPressed),
			sol::resolve<bool(ImGuiKey, bool)>(IsKeyPressed)
		));
